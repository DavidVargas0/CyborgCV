...
- Microcontroller to drive LEDs (code base was completed with a Rasberry Pi)
...
- UDP Network I/O to Rasberry Pi
...
- Receive messages from Grasshopper through UDP
...
- Camera will calibrate automatically, wait until calibration process fully completes.
...
- Run the CV script to track the marker / pen / chalk line
- Verify that the tracked position aligns with the model in Grasshopper

### 6. Draw with guidance
